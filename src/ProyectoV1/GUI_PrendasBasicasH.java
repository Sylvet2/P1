...
public class GUI_PrendasBasicasH extends javax.swing.JFrame {
    List<Prenda> listaBasicoHombre = new ArrayList<Prenda>();
    /**
    ...
    private void initComponents() {
        ...
        jPanel3.add(jPanel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 290, 330, 250));
        ...
        jPanel3.add(jPanel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(337, 290, 320, 250));
        ...
        jPanel4.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-200, 0, 940, 650));
    ...
    private void btnGuardarCamisetaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarCamisetaActionPerformed
        ...
        if (rbtSCamiseta.isSelected() == false && rbtMCamiseta.isSelected() == false && rbtLCamiseta.isSelected() == false){
            ...
            listaBasicoHombre.add(new Prenda (nombre, precio, cantidad, talla, color));
            }
